...
/**
 * The Class BresenhamPlotter. Plots a Bresenham line into passed in lambdas
 */
public class BresenhamPlotter {
    ...
    /**
     * Plots a line using the Bresenham line algorithm from (x0, y0) to (x1, y1)
     * and plots each point using the plot function.
     *
     * @param x0
     *            the start x
     * @param y0
    ...
    /**
     * Plots a line using the Bresenham line algorithm from (x0, y0) to (x1, y1)
     * and returns a list of the points.
     *
     * @param x0
     *            the start x
     * @param y0
